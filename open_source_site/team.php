...
<body>
    ...
    <div>
        ...
        <span class="border"></span>
        <div class="section">The project then became the work for the entire Fall 2023 class. Students were presented with documentation and checked out the repository in Git.  They took on tasks and moved things forward for the first 3 weeks of class.  Then another team took on the project for the rest of the semester.</div>
